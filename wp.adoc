:Title: OGC Technical Note: Modeling, Simulation and Prediction
:titletext: OGC Technical Note: Modeling, Simulation and Prediction
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
[cols = "^", frame = "none"]
|===
|[big]*OGC Technical Note: Modeling, Simulation and Prediction*
|===
